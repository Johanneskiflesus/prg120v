...
DROP DATABASE IF EXISTS studentadministrasjon;
CREATE DATABASE studentadministrasjon CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE studentadministrasjon;
